...
define("cv/violajones", [
  ...
  ViolaJones.detect = function(pixels, width, height, initialScale, scaleFactor, stepSize, edgesDensity) {
    ...
    return this.mergeRectangles(rects);
  };
   ...
   * @static
   */
  ViolaJones.evalStages = function(data, integralImage, integralImageSquare, tiltedIntegralImage, i, j, width, blockWidth, blockHeight, scale) {
   ...
   * @static
   */
  ViolaJones.mergeRectangles = function(rects) {
  ...
  ViolaJones.intersectRect = function(x0, y0, x1, y1, x2, y2, x3, y3) {
